...
// const light9_1 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_1 );
// light9_1.position.set(200,-155,370);
...
// const light9_2 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_2 );
// light9_2.position.set(230,-150,355);
...
// const light9_3 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_3 );
// light9_1.position.set(200,-155,370);
...
// const light9_4 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_4 );
// light9_4.position.set(250,-115,350);
...
// const light9_5 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_5 );
// light9_5.position.set(285,-70,340);
...
// const light9_6 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_6 );
// light9_6.position.set(255,-25,370);
...
// const light9_7 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_7 );
// light9_7.position.set(215,-35,392);
...
// const light9_8 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_8 );
// light9_8.position.set(200,-50,397);
...
// const light9_9 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_9 );
// light9_9.position.set(180,-30,410);
...
// const light9_10 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_10 );
// light9_10.position.set(200,-25,400);
...
// const light9_11 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_11 );
// light9_11.position.set(205,15,400);
...
// const light9_12 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_12 );
// light9_12.position.set(215,10,395);
...
// const light9_13 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_13 );
// light9_13.position.set(230,15,385);
...
// const light9_14 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_14 );
// light9_14.position.set(250,25,370);
...
// const light9_15 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_15 );
// light9_15.position.set(150,-20,420);
...
// const light9_16 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_16 );
// light9_16.position.set(140,20,425);
...
// const light9_17 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_17 );
// light9_17.position.set(140,20,425);
...
// const light9_18 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_18 );
// light9_18.position.set(115,-50,430);
...
// const light9_19 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_19 );
// light9_19.position.set(85,-25,440);
...
// const light9_20 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_20 );
// light9_20.position.set(145,-80,420);
...
// const light9_21 = new THREE.AmbientLight( 0x404040 ); // soft white light
// scene.add( light9_21 );
// light9_21.position.set(130,-85,420);

    const light_star9 = new THREE.PointLight(0xffffff,-1); // soft white light
    light_star9.position.set(300, 300, 500);
    scene.add(light_star9);
    ...
    function animate() {
        ...
        light_star9.intensity =4* (Math.abs(Math.sin((1 / 3) * Math.PI * (curTime-time))))
